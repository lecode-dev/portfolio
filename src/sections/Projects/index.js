...
function ProjectsSession() {
  const siteProps = [
    {
      name: "Camalẽao LAB",
      desc:
        "The Streetwear style was never just about clothes. It’s about identity, culture and freedom of expression. The future is already here. It’s time to adapt.",
      img: Proj1,
    ...
    },
    {
      ...
      img: Proj3,
      technologies: ["MongoDB", "Node.js", "React", "Browser Extension"],
      side: "left",
      firstElement: false,
      link: "https://extension.ethicsnet.org/"
    }
    // {
    //     name: 'SwiftSku',
  ...
  return (
    <Projects id="projects">
      <SessionTitle>
        <span>0010.</span>Some of our projects
      </SessionTitle>

      {siteProps.map((site) => (
        <Project
          websiteName={site.name}
          websiteDesc={site.desc}
          websiteImg={site.img}
          techArray={site.technologies}
          side={site.side}
          firstElement={site.firstElement}
