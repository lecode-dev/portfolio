    ...
    return (
        <About id="about">
            <div className="div-left">
                ...
                <Paragraph>We are on <a href="https://www.upwork.com/ag/lecode/" target="_blank" rel="noopener noreferrer">Upwork</a> so you can get our services from there. You can also contact us by <a href="mailto:lecode.dev@gmail.com?subject=Job Contact">sendind an email.</a> Feel free to chose the best option for you. For code samples and some open source projects that we’ve built, visit our <a href="https://github.com/lecode-dev/" target="_blank" rel="noopener noreferrer">Github page</a>.</Paragraph>
