    ...
    return(
        <Team id="team">
            ...
            <div>
                ...
                {member(Member4 ,'Marianne Matos', 'Front-end Developer', 'I’m a web developer, who speaks English, Portuguese and a little bit of French and is studying Information Systems at the State University of Montes Claros. Basically, I’m just someone who really loves technology and learning new things :)', 'https://www.instagram.com/mari_anne212/', 'https://twitter.com/', 'https://br.linkedin.com/', 'https://github.com/MariMatos2112')}
            </div>
        </Team>
    )
}
